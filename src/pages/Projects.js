export default function Projects() {
    return (
        <section id="projects"
            ...
            <h2 className="text-5xl text-purple-500 text-opacity-30 font-bold text-center">
                My Projects
            </h2>
            <div className="p-10 bg-purple-700 bg-opacity-30 flex flex-col justify-center items-center
                            gap-5 lg:flex-row max-w-5xl mx-auto shadow transition 
                            hover:shadow-xl hover:scale-[102%] w-full">
                <div className="w-80 rounded">  <a href=
                ...
                <div className="flex flex-col align-center mx-auto gap-4 justify-center flex-1">
                    <h2 className="font-bold text-3xl text-purple-800 uppercase text-center">
...
"https://www.geeksforgeeks.org/progress-tracker-using-react-and-local-storage/">
                    ...
                    <p className="text-purple-700 text-opacity-25 text-center">
                        This is a project built on react which tracks your progess in dsa 
                        and stores that in the local storage.
                    </p>
                </div>
            </div>
            <div className="p-10 bg-purple-700 bg-opacity-30 flex flex-col justify-center items-center gap-5 
